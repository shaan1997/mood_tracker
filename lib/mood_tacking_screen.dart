                  ...
                  children: [
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(child: Text('The team is feeling good today',maxLines: 2,style: TextStyle(color: Colors.white,fontSize: 20),)),
                          Padding(
                   ...
                   // Icon(Icons.format_quote),
                    ...
                    Padding(
                      ...
                      child: Image.asset(Res.ic_angel_emoji,height: 40,width: 40,),
                    )
                  ],
                ),
              ),
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      ...
                      child: Row(
                        children: [
                          Image.asset(Res.ic_angel_emoji,height: 40,width: 40,),
                          SizedBox(width: 10,),
                          Flexible(child: Text('Moodalytics',maxLines: 1,style: TextStyle(color: Colors.white,fontSize: 22,overflow: TextOverflow.ellipsis),))
                        ],
                      ),
                    ),
                    Flexible(flex: 2,child: Text('(Trend chart on Mood)',maxLines: 1,style: TextStyle(color: Colors.white,fontSize: 18),))
                  ],
                ),
              ),
              Container(
                ...
                child: LineChart(
                  LineChartData(
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        spots: controller.moodData.map((point) => FlSpot(double.parse(point.date!.day.toString()), double.parse(point.moodRate.toString()))).toList(),
                        isCurved: false,
                        color: Colors.green,
                        show: true,
                    ...
                    titlesData: ListTiles.getTitlesData(),
